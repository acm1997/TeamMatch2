...
public class VerEventoUITest {
    ...
    @Test
    public void shouldTestInterfaceCrearEvento() throws InterruptedException {
        ...
        onView(ViewMatchers.withId(R.id.my_recycler_view)).check(matches(isDisplayed()));//se comprueba que se muestre recycler view eventos.
